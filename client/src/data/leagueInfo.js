export const LEAGUE_INFO = {
  ...
  WNBA: {
    ...
    tier: 'Top Tier Pro',
    description: 'The WNBA is the top women\'s professional basketball league in the US, with 15 teams as of 2026, and plans to reach 18 by 2030.',
    website: 'wnba.com',
  },
  NHL: {
    fullName: 'National Hockey League',
    tier: 'Top Tier Pro',
    description: 'The NHL is the top professional ice hockey league in North America, with 32 teams competing for the Stanley Cup.',
    website: 'nhl.com',
  },
  NFL: {
  ...
  AHL: {
    ...
    tier: 'Minor League — NHL Affiliate Tier I',
  ...
  ECHL: {
    fullName: 'ECHL',
    tier: 'Minor League — NHL Affiliate Tier II',
  ...
  'Triple-A': {
    ...
    tier: 'Minor League — MLB Affiliate Tier I',
  ...
  'Double-A': {
    ...
    tier: 'Minor League — MLB Affiliate Tier II',
  ...
  'High-A': {
    fullName: 'High-A (A+)',
    tier: 'Minor League — MLB Affiliate Tier III',
  ...
  'Single-A': {
    fullName: 'Single-A (A)',
    tier: 'Minor League — MLB Affiliate Tier IV',
